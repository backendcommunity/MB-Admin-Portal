...
/**
   ...
   * `prisma.bootcamp`: Exposes CRUD operations for the **Bootcamp** model.
    ...
    * ```
    */
  get bootcamp(): Prisma.BootcampDelegate<GlobalReject>;
   ...
   * `prisma.cohort`: Exposes CRUD operations for the **Cohort** model.
    ...
    * ```
    */
  get cohort(): Prisma.CohortDelegate<GlobalReject>;
...
export namespace Prisma {
  ...
  */
  ...
  export type BootcampCountOutputTypeSelect = {
    cohorts?: boolean
  }

  export type BootcampCountOutputTypeGetPayload<S extends boolean | null | undefined | BootcampCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? BootcampCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (BootcampCountOutputTypeArgs)
    ? BootcampCountOutputType 
    : S extends { select: any } & (BootcampCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof BootcampCountOutputType ? BootcampCountOutputType[P] : never
  } 
      : BootcampCountOutputType
   ...
   */
  export type BootcampCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the BootcampCountOutputType
     */
    select?: BootcampCountOutputTypeSelect | null
  }
  ...
  export type CohortCountOutputTypeSelect = {
    enrollments?: boolean
  }

  export type CohortCountOutputTypeGetPayload<S extends boolean | null | undefined | CohortCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? CohortCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (CohortCountOutputTypeArgs)
    ? CohortCountOutputType 
    : S extends { select: any } & (CohortCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof CohortCountOutputType ? CohortCountOutputType[P] : never
  } 
      : CohortCountOutputType
   ...
   */
  export type CohortCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the CohortCountOutputType
     */
    select?: CohortCountOutputTypeSelect | null
  }
  ...
  export type ChapterCountOutputTypeGetPayload<S extends boolean | null | undefined | ChapterCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? ChapterCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (ChapterCountOutputTypeArgs)
    ? ChapterCountOutputType 
    : S extends { select: any } & (ChapterCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
  ...
  export type UserSelect = {
    ...
    createdAt?: boolean
    updatedAt?: boolean
    enrollments?: boolean | User$enrollmentsArgs
  ...
  export class Prisma__UserClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    enrollments<T extends User$enrollmentsArgs= {}>(args?: Subset<T, User$enrollmentsArgs>): Prisma.PrismaPromise<Array<EnrollmentGetPayload<T>>| Null>;
  ...
  export type CourseSelect = {
    ...
    createdAt?: boolean
    updatedAt?: boolean
    chapters?: boolean | Course$chaptersArgs
  ...
  export class Prisma__CourseClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    chapters<T extends Course$chaptersArgs= {}>(args?: Subset<T, Course$chaptersArgs>): Prisma.PrismaPromise<Array<ChapterGetPayload<T>>| Null>;
  ...
  export type BootcampAggregateArgs = {
    /**
     ...
     */
    orderBy?: Enumerable<BootcampOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type BootcampGroupByArgs = {
    where?: BootcampWhereInput
    orderBy?: Enumerable<BootcampOrderByWithAggregationInput>
    by: BootcampScalarFieldEnum[]
  ...
  type GetBootcampGroupByPayload<T extends BootcampGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<BootcampGroupByOutputType, T['by']> &
        {
  ...
  export type BootcampSelect = {
    ...
    createdAt?: boolean
    updatedAt?: boolean
    cohorts?: boolean | Bootcamp$cohortsArgs
    _count?: boolean | BootcampCountOutputTypeArgs
  }


  export type BootcampInclude = {
    cohorts?: boolean | Bootcamp$cohortsArgs
    _count?: boolean | BootcampCountOutputTypeArgs
  }

  export type BootcampGetPayload<S extends boolean | null | undefined | BootcampArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Bootcamp :
    S extends undefined ? never :
    S extends { include: any } & (BootcampArgs | BootcampFindManyArgs)
    ? Bootcamp  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'cohorts' ? Array < CohortGetPayload<S['include'][P]>>  :
        P extends '_count' ? BootcampCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (BootcampArgs | BootcampFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'cohorts' ? Array < CohortGetPayload<S['select'][P]>>  :
        P extends '_count' ? BootcampCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof Bootcamp ? Bootcamp[P] : never
  } 
      : Bootcamp


  type BootcampCountArgs = 
    Omit<BootcampFindManyArgs, 'select' | 'include'> & {
      select?: BootcampCountAggregateInputType | true
    }

  export interface BootcampDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends BootcampFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, BootcampFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Bootcamp'> extends True ? Prisma__BootcampClient<BootcampGetPayload<T>> : Prisma__BootcampClient<BootcampGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends BootcampFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, BootcampFindUniqueOrThrowArgs>
    ): Prisma__BootcampClient<BootcampGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends BootcampFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, BootcampFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Bootcamp'> extends True ? Prisma__BootcampClient<BootcampGetPayload<T>> : Prisma__BootcampClient<BootcampGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends BootcampFindFirstOrThrowArgs>(
      args?: SelectSubset<T, BootcampFindFirstOrThrowArgs>
    ): Prisma__BootcampClient<BootcampGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends BootcampFindManyArgs>(
      args?: SelectSubset<T, BootcampFindManyArgs>
    ): Prisma.PrismaPromise<Array<BootcampGetPayload<T>>>
     ...
     * 
    **/
    create<T extends BootcampCreateArgs>(
      args: SelectSubset<T, BootcampCreateArgs>
    ): Prisma__BootcampClient<BootcampGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends BootcampCreateManyArgs>(
      args?: SelectSubset<T, BootcampCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends BootcampDeleteArgs>(
      args: SelectSubset<T, BootcampDeleteArgs>
    ): Prisma__BootcampClient<BootcampGetPayload<T>>
     ...
     * 
    **/
    update<T extends BootcampUpdateArgs>(
      args: SelectSubset<T, BootcampUpdateArgs>
    ): Prisma__BootcampClient<BootcampGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends BootcampDeleteManyArgs>(
      args?: SelectSubset<T, BootcampDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends BootcampUpdateManyArgs>(
      args: SelectSubset<T, BootcampUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends BootcampUpsertArgs>(
      args: SelectSubset<T, BootcampUpsertArgs>
    ): Prisma__BootcampClient<BootcampGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__BootcampClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    cohorts<T extends Bootcamp$cohortsArgs= {}>(args?: Subset<T, Bootcamp$cohortsArgs>): Prisma.PrismaPromise<Array<CohortGetPayload<T>>| Null>;
  ...
  /**
   * Bootcamp base type for findUnique actions
   */
  export type BootcampFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: BootcampInclude | null
    /**
   ...
   * Bootcamp findUnique
   */
  export interface BootcampFindUniqueArgs extends BootcampFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type BootcampFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
  ...
  /**
   * Bootcamp base type for findFirst actions
   */
  export type BootcampFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
     ...
     */
    distinct?: Enumerable<BootcampScalarFieldEnum>
  }

  /**
   * Bootcamp findFirst
   */
  export interface BootcampFindFirstArgs extends BootcampFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type BootcampFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
   ...
   * Bootcamp findMany
   */
  export type BootcampFindManyArgs = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
   ...
   * Bootcamp create
   */
  export type BootcampCreateArgs = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
   ...
   * Bootcamp createMany
   */
  export type BootcampCreateManyArgs = {
    /**
     * The data used to create many Bootcamps.
     */
    data: Enumerable<BootcampCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * Bootcamp update
   */
  export type BootcampUpdateArgs = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
   ...
   * Bootcamp updateMany
   */
  export type BootcampUpdateManyArgs = {
    /**
   ...
   * Bootcamp upsert
   */
  export type BootcampUpsertArgs = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
   ...
   * Bootcamp delete
   */
  export type BootcampDeleteArgs = {
    /**
     * Select specific fields to fetch from the Bootcamp
     */
    select?: BootcampSelect | null
   ...
   * Bootcamp deleteMany
   */
  export type BootcampDeleteManyArgs = {
    /**
   ...
   * Bootcamp.cohorts
   */
  export type Bootcamp$cohortsArgs = {
    /**
     * Select specific fields to fetch from the Cohort
     */
    select?: CohortSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: CohortInclude | null
    where?: CohortWhereInput
    orderBy?: Enumerable<CohortOrderByWithRelationInput>
    cursor?: CohortWhereUniqueInput
    take?: number
    skip?: number
    distinct?: Enumerable<CohortScalarFieldEnum>
  }
  ...
  export type CohortAggregateArgs = {
    /**
  ...
  export type CohortGroupByArgs = {
    where?: CohortWhereInput
    orderBy?: Enumerable<CohortOrderByWithAggregationInput>
    by: CohortScalarFieldEnum[]
  ...
  type GetCohortGroupByPayload<T extends CohortGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<CohortGroupByOutputType, T['by']> &
        {
  ...
  export type CohortSelect = {
    id?: boolean
    name?: boolean
    bootcampId?: boolean
    createdAt?: boolean
    updatedAt?: boolean
    bootcamp?: boolean | BootcampArgs
    enrollments?: boolean | Cohort$enrollmentsArgs
    _count?: boolean | CohortCountOutputTypeArgs
  }


  export type CohortInclude = {
    bootcamp?: boolean | BootcampArgs
    enrollments?: boolean | Cohort$enrollmentsArgs
    _count?: boolean | CohortCountOutputTypeArgs
  }

  export type CohortGetPayload<S extends boolean | null | undefined | CohortArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Cohort :
    S extends undefined ? never :
    S extends { include: any } & (CohortArgs | CohortFindManyArgs)
    ? Cohort  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'bootcamp' ? BootcampGetPayload<S['include'][P]> :
        P extends 'enrollments' ? Array < EnrollmentGetPayload<S['include'][P]>>  :
        P extends '_count' ? CohortCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (CohortArgs | CohortFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'bootcamp' ? BootcampGetPayload<S['select'][P]> :
        P extends 'enrollments' ? Array < EnrollmentGetPayload<S['select'][P]>>  :
        P extends '_count' ? CohortCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof Cohort ? Cohort[P] : never
  } 
      : Cohort


  type CohortCountArgs = 
    Omit<CohortFindManyArgs, 'select' | 'include'> & {
      select?: CohortCountAggregateInputType | true
    }

  export interface CohortDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends CohortFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, CohortFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Cohort'> extends True ? Prisma__CohortClient<CohortGetPayload<T>> : Prisma__CohortClient<CohortGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends CohortFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, CohortFindUniqueOrThrowArgs>
    ): Prisma__CohortClient<CohortGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends CohortFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, CohortFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Cohort'> extends True ? Prisma__CohortClient<CohortGetPayload<T>> : Prisma__CohortClient<CohortGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends CohortFindFirstOrThrowArgs>(
      args?: SelectSubset<T, CohortFindFirstOrThrowArgs>
    ): Prisma__CohortClient<CohortGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends CohortFindManyArgs>(
      args?: SelectSubset<T, CohortFindManyArgs>
    ): Prisma.PrismaPromise<Array<CohortGetPayload<T>>>
     ...
     * 
    **/
    create<T extends CohortCreateArgs>(
      args: SelectSubset<T, CohortCreateArgs>
    ): Prisma__CohortClient<CohortGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends CohortCreateManyArgs>(
      args?: SelectSubset<T, CohortCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends CohortDeleteArgs>(
      args: SelectSubset<T, CohortDeleteArgs>
    ): Prisma__CohortClient<CohortGetPayload<T>>
     ...
     * 
    **/
    update<T extends CohortUpdateArgs>(
      args: SelectSubset<T, CohortUpdateArgs>
    ): Prisma__CohortClient<CohortGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends CohortDeleteManyArgs>(
      args?: SelectSubset<T, CohortDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends CohortUpdateManyArgs>(
      args: SelectSubset<T, CohortUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends CohortUpsertArgs>(
      args: SelectSubset<T, CohortUpsertArgs>
    ): Prisma__CohortClient<CohortGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CohortClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    bootcamp<T extends BootcampArgs= {}>(args?: Subset<T, BootcampArgs>): Prisma__BootcampClient<BootcampGetPayload<T> | Null>;

    enrollments<T extends Cohort$enrollmentsArgs= {}>(args?: Subset<T, Cohort$enrollmentsArgs>): Prisma.PrismaPromise<Array<EnrollmentGetPayload<T>>| Null>;
  ...
  /**
   * Cohort base type for findUnique actions
   */
  export type CohortFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Cohort
     */
    select?: CohortSelect | null
   ...
   * Cohort findUnique
   */
  export interface CohortFindUniqueArgs extends CohortFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type CohortFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Cohort
     */
    select?: CohortSelect | null
  ...
  /**
   * Cohort base type for findFirst actions
   */
  export type CohortFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Cohort
     */
    select?: CohortSelect | null
   ...
   * Cohort findFirst
   */
  export interface CohortFindFirstArgs extends CohortFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type CohortFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Cohort
     */
    select?: CohortSelect | null
   ...
   * Cohort createMany
   */
  export type CohortCreateManyArgs = {
    /**
     * The data used to create many Cohorts.
     */
    data: Enumerable<CohortCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * Cohort updateMany
   */
  export type CohortUpdateManyArgs = {
    /**
   ...
   * Cohort deleteMany
   */
  export type CohortDeleteManyArgs = {
    /**
   ...
   * Cohort.enrollments
   */
  export type Cohort$enrollmentsArgs = {
    /**
     * Select specific fields to fetch from the Enrollment
     */
    select?: EnrollmentSelect | null
  ...
  export type EnrollmentGetPayload<S extends boolean | null | undefined | EnrollmentArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'cohort' ? CohortGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (EnrollmentArgs | EnrollmentFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :
        P extends 'cohort' ? CohortGetPayload<S['select'][P]> :  P extends keyof Enrollment ? Enrollment[P] : never
  } 
      : Enrollment
  ...
  export interface EnrollmentDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<EnrollmentGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__EnrollmentClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    cohort<T extends CohortArgs= {}>(args?: Subset<T, CohortArgs>): Prisma__CohortClient<CohortGetPayload<T> | Null>;
  ...
  export type ChapterSelect = {
    ...
    lessons?: boolean | Chapter$lessonsArgs
  ...
  export type ChapterGetPayload<S extends boolean | null | undefined | ChapterArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Chapter :
    S extends undefined ? never :
    S extends { include: any } & (ChapterArgs | ChapterFindManyArgs)
    ? Chapter  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'course' ? CourseGetPayload<S['include'][P]> :
        P extends 'lessons' ? Array < LessonGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'lessons' ? Array < LessonGetPayload<S['select'][P]>>  :
        P extends '_count' ? ChapterCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof Chapter ? Chapter[P] : never
  } 
      : Chapter


  type ChapterCountArgs = 
    Omit<ChapterFindManyArgs, 'select' | 'include'> & {
      select?: ChapterCountAggregateInputType | true
    }

  export interface ChapterDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Chapter'> extends True ? Prisma__ChapterClient<ChapterGetPayload<T>> : Prisma__ChapterClient<ChapterGetPayload<T> | null, null>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Chapter'> extends True ? Prisma__ChapterClient<ChapterGetPayload<T>> : Prisma__ChapterClient<ChapterGetPayload<T> | null, null>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ChapterClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    lessons<T extends Chapter$lessonsArgs= {}>(args?: Subset<T, Chapter$lessonsArgs>): Prisma.PrismaPromise<Array<LessonGetPayload<T>>| Null>;
   ...
   * Chapter.lessons
   */
  export type Chapter$lessonsArgs = {
    /**
  ...
  export type LessonGetPayload<S extends boolean | null | undefined | LessonArgs> =
    ...
    ? Lesson  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'chapter' ? ChapterGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (LessonArgs | LessonFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'chapter' ? ChapterGetPayload<S['select'][P]> :  P extends keyof Lesson ? Lesson[P] : never
  } 
      : Lesson
  ...
  export class Prisma__LessonClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    chapter<T extends ChapterArgs= {}>(args?: Subset<T, ChapterArgs>): Prisma__ChapterClient<ChapterGetPayload<T> | Null>;
  ...
  export type CourseWhereInput = {
    ...
    instructor?: StringNullableFilter | string | null
  ...
  export type CourseScalarWhereWithAggregatesInput = {
    ...
    instructor?: StringNullableWithAggregatesFilter | string | null
  ...
  export type BootcampWhereInput = {
    AND?: Enumerable<BootcampWhereInput>
    OR?: Enumerable<BootcampWhereInput>
    NOT?: Enumerable<BootcampWhereInput>
    id?: IntFilter | number
  ...
  export type BootcampWhereUniqueInput = {
    id?: number
  }
  ...
  export type BootcampScalarWhereWithAggregatesInput = {
    AND?: Enumerable<BootcampScalarWhereWithAggregatesInput>
    OR?: Enumerable<BootcampScalarWhereWithAggregatesInput>
    NOT?: Enumerable<BootcampScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
  ...
  export type CohortWhereInput = {
    AND?: Enumerable<CohortWhereInput>
    OR?: Enumerable<CohortWhereInput>
    NOT?: Enumerable<CohortWhereInput>
    id?: IntFilter | number
    name?: StringFilter | string
    bootcampId?: IntFilter | number
    createdAt?: DateTimeFilter | Date | string
    updatedAt?: DateTimeFilter | Date | string
  ...
  export type CohortWhereUniqueInput = {
    id?: number
  }
  ...
  export type CohortScalarWhereWithAggregatesInput = {
    AND?: Enumerable<CohortScalarWhereWithAggregatesInput>
    OR?: Enumerable<CohortScalarWhereWithAggregatesInput>
    NOT?: Enumerable<CohortScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    name?: StringWithAggregatesFilter | string
    bootcampId?: IntWithAggregatesFilter | number
    createdAt?: DateTimeWithAggregatesFilter | Date | string
    updatedAt?: DateTimeWithAggregatesFilter | Date | string
  }
  ...
  export type EnrollmentWhereInput = {
    ...
    cohortId?: IntFilter | number
    role?: StringFilter | string
    createdAt?: DateTimeFilter | Date | string
    user?: XOR<UserRelationFilter, UserWhereInput>
    cohort?: XOR<CohortRelationFilter, CohortWhereInput>
  }
  ...
  export type EnrollmentScalarWhereWithAggregatesInput = {
    ...
    cohortId?: IntWithAggregatesFilter | number
    role?: StringWithAggregatesFilter | string
    createdAt?: DateTimeWithAggregatesFilter | Date | string
  }
  ...
  export type BootcampCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    cohorts?: CohortCreateNestedManyWithoutBootcampInput
  }
  ...
  export type BootcampUncheckedCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    cohorts?: CohortUncheckedCreateNestedManyWithoutBootcampInput
  }
  ...
  export type BootcampUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    cohorts?: CohortUpdateManyWithoutBootcampNestedInput
  }
  ...
  export type BootcampUncheckedUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    cohorts?: CohortUncheckedUpdateManyWithoutBootcampNestedInput
  }
  ...
  export type CohortCreateInput = {
    ...
    createdAt?: Date | string
    updatedAt?: Date | string
    bootcamp: BootcampCreateNestedOneWithoutCohortsInput
  ...
  export type CohortUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    bootcamp?: BootcampUpdateOneRequiredWithoutCohortsNestedInput
  ...
  export type CohortRelationFilter = {
    is?: CohortWhereInput
  ...
  export type ChapterCreateNestedManyWithoutCourseInput = {
    create?: XOR<Enumerable<ChapterCreateWithoutCourseInput>, Enumerable<ChapterUncheckedCreateWithoutCourseInput>>
    connectOrCreate?: Enumerable<ChapterCreateOrConnectWithoutCourseInput>
  ...
  export type ChapterUpdateManyWithoutCourseNestedInput = {
    create?: XOR<Enumerable<ChapterCreateWithoutCourseInput>, Enumerable<ChapterUncheckedCreateWithoutCourseInput>>
    connectOrCreate?: Enumerable<ChapterCreateOrConnectWithoutCourseInput>
    upsert?: Enumerable<ChapterUpsertWithWhereUniqueWithoutCourseInput>
    createMany?: ChapterCreateManyCourseInputEnvelope
    ...
    connect?: Enumerable<ChapterWhereUniqueInput>
    update?: Enumerable<ChapterUpdateWithWhereUniqueWithoutCourseInput>
    updateMany?: Enumerable<ChapterUpdateManyWithWhereWithoutCourseInput>
  ...
  export type CohortCreateNestedManyWithoutBootcampInput = {
    create?: XOR<Enumerable<CohortCreateWithoutBootcampInput>, Enumerable<CohortUncheckedCreateWithoutBootcampInput>>
    connectOrCreate?: Enumerable<CohortCreateOrConnectWithoutBootcampInput>
    createMany?: CohortCreateManyBootcampInputEnvelope
    connect?: Enumerable<CohortWhereUniqueInput>
  }

  export type CohortUncheckedCreateNestedManyWithoutBootcampInput = {
    create?: XOR<Enumerable<CohortCreateWithoutBootcampInput>, Enumerable<CohortUncheckedCreateWithoutBootcampInput>>
    connectOrCreate?: Enumerable<CohortCreateOrConnectWithoutBootcampInput>
    createMany?: CohortCreateManyBootcampInputEnvelope
    connect?: Enumerable<CohortWhereUniqueInput>
  ...
  export type CohortUpdateManyWithoutBootcampNestedInput = {
    create?: XOR<Enumerable<CohortCreateWithoutBootcampInput>, Enumerable<CohortUncheckedCreateWithoutBootcampInput>>
    connectOrCreate?: Enumerable<CohortCreateOrConnectWithoutBootcampInput>
    upsert?: Enumerable<CohortUpsertWithWhereUniqueWithoutBootcampInput>
    createMany?: CohortCreateManyBootcampInputEnvelope
    set?: Enumerable<CohortWhereUniqueInput>
    disconnect?: Enumerable<CohortWhereUniqueInput>
    delete?: Enumerable<CohortWhereUniqueInput>
    connect?: Enumerable<CohortWhereUniqueInput>
    update?: Enumerable<CohortUpdateWithWhereUniqueWithoutBootcampInput>
    updateMany?: Enumerable<CohortUpdateManyWithWhereWithoutBootcampInput>
    deleteMany?: Enumerable<CohortScalarWhereInput>
  }

  export type CohortUncheckedUpdateManyWithoutBootcampNestedInput = {
    create?: XOR<Enumerable<CohortCreateWithoutBootcampInput>, Enumerable<CohortUncheckedCreateWithoutBootcampInput>>
    connectOrCreate?: Enumerable<CohortCreateOrConnectWithoutBootcampInput>
    upsert?: Enumerable<CohortUpsertWithWhereUniqueWithoutBootcampInput>
    createMany?: CohortCreateManyBootcampInputEnvelope
  ...
  export type BootcampCreateNestedOneWithoutCohortsInput = {
    create?: XOR<BootcampCreateWithoutCohortsInput, BootcampUncheckedCreateWithoutCohortsInput>
    connectOrCreate?: BootcampCreateOrConnectWithoutCohortsInput
    connect?: BootcampWhereUniqueInput
  }

  export type EnrollmentCreateNestedManyWithoutCohortInput = {
    create?: XOR<Enumerable<EnrollmentCreateWithoutCohortInput>, Enumerable<EnrollmentUncheckedCreateWithoutCohortInput>>
    connectOrCreate?: Enumerable<EnrollmentCreateOrConnectWithoutCohortInput>
  ...
  export type BootcampUpdateOneRequiredWithoutCohortsNestedInput = {
    create?: XOR<BootcampCreateWithoutCohortsInput, BootcampUncheckedCreateWithoutCohortsInput>
    connectOrCreate?: BootcampCreateOrConnectWithoutCohortsInput
    upsert?: BootcampUpsertWithoutCohortsInput
    connect?: BootcampWhereUniqueInput
    update?: XOR<BootcampUpdateWithoutCohortsInput, BootcampUncheckedUpdateWithoutCohortsInput>
  }

  export type EnrollmentUpdateManyWithoutCohortNestedInput = {
    create?: XOR<Enumerable<EnrollmentCreateWithoutCohortInput>, Enumerable<EnrollmentUncheckedCreateWithoutCohortInput>>
    connectOrCreate?: Enumerable<EnrollmentCreateOrConnectWithoutCohortInput>
    upsert?: Enumerable<EnrollmentUpsertWithWhereUniqueWithoutCohortInput>
    createMany?: EnrollmentCreateManyCohortInputEnvelope
    set?: Enumerable<EnrollmentWhereUniqueInput>
    disconnect?: Enumerable<EnrollmentWhereUniqueInput>
    delete?: Enumerable<EnrollmentWhereUniqueInput>
    connect?: Enumerable<EnrollmentWhereUniqueInput>
    update?: Enumerable<EnrollmentUpdateWithWhereUniqueWithoutCohortInput>
    updateMany?: Enumerable<EnrollmentUpdateManyWithWhereWithoutCohortInput>
    deleteMany?: Enumerable<EnrollmentScalarWhereInput>
  }
  ...
  export type LessonCreateNestedManyWithoutChapterInput = {
    create?: XOR<Enumerable<LessonCreateWithoutChapterInput>, Enumerable<LessonUncheckedCreateWithoutChapterInput>>
    connectOrCreate?: Enumerable<LessonCreateOrConnectWithoutChapterInput>
  ...
  export type LessonUpdateManyWithoutChapterNestedInput = {
    create?: XOR<Enumerable<LessonCreateWithoutChapterInput>, Enumerable<LessonUncheckedCreateWithoutChapterInput>>
    connectOrCreate?: Enumerable<LessonCreateOrConnectWithoutChapterInput>
    upsert?: Enumerable<LessonUpsertWithWhereUniqueWithoutChapterInput>
    createMany?: LessonCreateManyChapterInputEnvelope
    ...
    connect?: Enumerable<LessonWhereUniqueInput>
    update?: Enumerable<LessonUpdateWithWhereUniqueWithoutChapterInput>
    updateMany?: Enumerable<LessonUpdateManyWithWhereWithoutChapterInput>
  ...
  export type ChapterCreateManyCourseInputEnvelope = {
    data: Enumerable<ChapterCreateManyCourseInput>
    skipDuplicates?: boolean
  }
  ...
  export type ChapterUpdateManyWithWhereWithoutCourseInput = {
    ...
    data: XOR<ChapterUpdateManyMutationInput, ChapterUncheckedUpdateManyWithoutChaptersInput>
  }
  ...
  export type CohortCreateWithoutBootcampInput = {
    name: string
    createdAt?: Date | string
    updatedAt?: Date | string
    enrollments?: EnrollmentCreateNestedManyWithoutCohortInput
  ...
  export type CohortUncheckedCreateWithoutBootcampInput = {
    id?: number
    name: string
    createdAt?: Date | string
    updatedAt?: Date | string
  ...
  export type CohortCreateOrConnectWithoutBootcampInput = {
    where: CohortWhereUniqueInput
    create: XOR<CohortCreateWithoutBootcampInput, CohortUncheckedCreateWithoutBootcampInput>
  }

  export type CohortCreateManyBootcampInputEnvelope = {
    data: Enumerable<CohortCreateManyBootcampInput>
    skipDuplicates?: boolean
  }

  export type CohortUpsertWithWhereUniqueWithoutBootcampInput = {
    where: CohortWhereUniqueInput
    update: XOR<CohortUpdateWithoutBootcampInput, CohortUncheckedUpdateWithoutBootcampInput>
    create: XOR<CohortCreateWithoutBootcampInput, CohortUncheckedCreateWithoutBootcampInput>
  }

  export type CohortUpdateWithWhereUniqueWithoutBootcampInput = {
    where: CohortWhereUniqueInput
    data: XOR<CohortUpdateWithoutBootcampInput, CohortUncheckedUpdateWithoutBootcampInput>
  }

  export type CohortUpdateManyWithWhereWithoutBootcampInput = {
    where: CohortScalarWhereInput
    data: XOR<CohortUpdateManyMutationInput, CohortUncheckedUpdateManyWithoutCohortsInput>
  }

  export type CohortScalarWhereInput = {
    AND?: Enumerable<CohortScalarWhereInput>
    OR?: Enumerable<CohortScalarWhereInput>
    NOT?: Enumerable<CohortScalarWhereInput>
    id?: IntFilter | number
    name?: StringFilter | string
    bootcampId?: IntFilter | number
    createdAt?: DateTimeFilter | Date | string
  ...
  export type BootcampCreateWithoutCohortsInput = {
    name: string
    description?: string | null
    location?: string | null
    active?: boolean
  ...
  export type BootcampUncheckedCreateWithoutCohortsInput = {
    id?: number
    name: string
    description?: string | null
    location?: string | null
  ...
  export type BootcampCreateOrConnectWithoutCohortsInput = {
    where: BootcampWhereUniqueInput
    create: XOR<BootcampCreateWithoutCohortsInput, BootcampUncheckedCreateWithoutCohortsInput>
  }
  ...
  export type EnrollmentCreateManyCohortInputEnvelope = {
    data: Enumerable<EnrollmentCreateManyCohortInput>
    skipDuplicates?: boolean
  }

  export type BootcampUpsertWithoutCohortsInput = {
    update: XOR<BootcampUpdateWithoutCohortsInput, BootcampUncheckedUpdateWithoutCohortsInput>
    create: XOR<BootcampCreateWithoutCohortsInput, BootcampUncheckedCreateWithoutCohortsInput>
  }

  export type BootcampUpdateWithoutCohortsInput = {
    name?: StringFieldUpdateOperationsInput | string
    description?: NullableStringFieldUpdateOperationsInput | string | null
    location?: NullableStringFieldUpdateOperationsInput | string | null
    active?: BoolFieldUpdateOperationsInput | boolean
  ...
  export type BootcampUncheckedUpdateWithoutCohortsInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    description?: NullableStringFieldUpdateOperationsInput | string | null
    location?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type LessonCreateManyChapterInputEnvelope = {
    data: Enumerable<LessonCreateManyChapterInput>
    skipDuplicates?: boolean
  }
  ...
  export type ChapterUncheckedUpdateManyWithoutChaptersInput = {
    id?: IntFieldUpdateOperationsInput | number
    title?: StringFieldUpdateOperationsInput | string
    order?: IntFieldUpdateOperationsInput | number
  }

  export type CohortCreateManyBootcampInput = {
    id?: number
    name: string
    createdAt?: Date | string
    updatedAt?: Date | string
  ...
  export type CohortUpdateWithoutBootcampInput = {
    name?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    enrollments?: EnrollmentUpdateManyWithoutCohortNestedInput
  ...
  export type CohortUncheckedUpdateWithoutBootcampInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type CohortUncheckedUpdateManyWithoutCohortsInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
